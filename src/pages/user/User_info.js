...
import ImagenUser from "../../img/user-img.jpg";
                      ...
                      <div className="col-9">
                             ...
                             id="nombre"
                              ...
                              <form className="form-direccion-facturacion-usuario">
                                <div className="mb-3 text-label-form-user">
                                  <label
                                    htmlFor="direccion-facturacion-usuario"
                                ...
                                <div className="mb-3 text-label-form-user">
                                  <label
                                    htmlFor="dato-direccion-facturacion-2"
                                    className="form-label text-label"
                                  >
                                    Dato
                                  </label>
                                ...
                                <div className="mb-3 text-label-form-user">
                                  <label
                                    htmlFor="dato-direccion-facturacion-3"
                                    className="form-label text-label"
                                  >
                                    Dato
                                  </label>
                              ...
                              <form className="form-direccion-envio-usuario">
                                <div className="mb-3 text-label-form-user">
                                  <label
                                    htmlFor="direccion-envio-usuario"
                                    className="form-label text-label"
                                  >
                                    Dirección
                                  </label>
                                ...
                                <div className="mb-3 text-label-form-user">
                                  <label
                                    htmlFor="dato-direccion-envio-usuario-1"
                                    className="form-label text-label"
                                  >
                                    Dato
                                  </label>
                                ...
                                <div className="mb-3 text-label-form-user">
                                  <label
                                    htmlFor="dato-direccion-envio-usuario-2"
                                    className="form-label text-label"
                                  >
                                    Dato 2
                                  </label>
